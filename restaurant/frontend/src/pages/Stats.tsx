...
import { Award, BarChart3, CalendarRange, TrendingUp } from 'lucide-react'
                ...
                <div key={plat.plat_id} className="rounded-xl border border-card-light bg-card-light p-4">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                     ...
                     <span className="text-xs rounded-full px-3 py-1 bg-primary/20 text-primary inline-flex items-center justify-center">#{index + 1}</span>
                  </div>
