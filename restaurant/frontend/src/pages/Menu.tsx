                ...
                <div key={plat.id} className="bg-card rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow border border-card-light">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className={`inline-flex items-center justify-center px-3 py-1 rounded-full text-sm ${plat.disponible ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'}`}>
